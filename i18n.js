...
(function () {
  ...
  var T = {
    ja: {
      ...
      heroSub: "高品質のスチールパネル。Zeton Garage製、伝説のスバル・インプレッサWRCとスバル22Bクーペのために。",
      ...
      prodBumpDesc: "カーボン補強のFRP複合バンパー。エポキシ樹脂とステンレス製フィッティング。",
      prodWingDesc: "FRP複合材にカーボン補強とエポキシ樹脂を用いた、象徴的な22Bリアウイング。",
      prodFullDesc: "全ボディパネルにバンパーとリアウイングを加えた、完全な22Bセット。",
    ...
    zh: {
      ...
      heroSub: "由Zeton Garage制造的高品质钢制板件，专为传奇的斯巴鲁翼豹WRC与斯巴鲁22B Coupe打造。",
      ...
      prodBumpDesc: "碳纤维强化的FRP复合保险杠，采用环氧树脂与不锈钢配件。",
      prodWingDesc: "标志性的22B尾翼，采用FRP复合材料、碳纤维强化与环氧树脂。",
      prodFullDesc: "完整的22B套装，所有车身板件加上保险杠与尾翼，一次购齐。",
    ...
    vi: {
      ...
      heroSub: "Tấm thép cao cấp do Zeton Garage sản xuất cho Subaru Impreza WRC và Subaru 22B Coupe huyền thoại.",
      ...
      prodBumpDesc: "Cản FRP composite gia cường sợi carbon, dùng nhựa epoxy và ốc vít thép không gỉ.",
      prodWingDesc: "Cánh gió sau 22B biểu tượng bằng FRP composite, gia cường carbon và nhựa epoxy.",
      prodFullDesc: "Trọn bộ 22B: tất cả tấm thân vỏ cùng cản và cánh gió sau trong một đơn hàng.",
    ...
    th: {
      ...
      heroSub: "แผงเหล็กเกรดสูง ผลิตโดย Zeton Garage สำหรับ Subaru Impreza WRC และ Subaru 22B Coupe ในตำนาน",
      ...
      prodBumpDesc: "กันชนคอมโพสิต FRP เสริมคาร์บอน ใช้เรซินอีพ็อกซีและอุปกรณ์ยึดสแตนเลส",
      prodWingDesc: "สปอยเลอร์หลัง 22B อันเป็นเอกลักษณ์ จากคอมโพสิต FRP เสริมคาร์บอนและเรซินอีพ็อกซี",
      prodFullDesc: "ชุด 22B แบบครบ ทุกแผงตัวถัง พร้อมกันชนและสปอยเลอร์หลัง ในออร์เดอร์เดียว",
    ...
    ko: {
      ...
      heroSub: "전설적인 스바루 임프레자 WRC와 스바루 22B 쿠페를 위한 Zeton Garage 제작 고급 스틸 패널.",
      ...
      prodBumpDesc: "카본 보강 FRP 컴포지트 범퍼, 에폭시 레진과 스테인리스 하드웨어.",
      prodWingDesc: "카본 보강과 에폭시 레진을 적용한 상징적인 22B 리어 윙, FRP 컴포지트.",
      prodFullDesc: "모든 바디 패널에 범퍼와 리어 윙까지 더한 완전한 22B 세트.",
