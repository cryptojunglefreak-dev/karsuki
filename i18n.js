...
(function () {
  ...
  var T = {
    ja: {
      ...
      heroTitle: 'プレミアム スチール ボディパネル<br /><span class="accent-line">スバルの名車のために。</span>',
      ...
      comingSoon: "近日公開", soonBig: "近日公開", inDev: "開発中",
    ...
    zh: {
      ...
      heroEyebrow: "亚洲官方经销商",
      heroTitle: '顶级钢制车身板件<br /><span class="accent-line">致敬传奇斯巴鲁。</span>',
      ...
      comingSoon: "即将推出", soonBig: "即将推出", inDev: "开发中",
    ...
    vi: {
      ...
      heroTitle: 'Tấm thân vỏ thép cao cấp<br /><span class="accent-line">cho biểu tượng Subaru.</span>',
      ...
      comingSoon: "Sắp ra mắt", soonBig: "Sắp ra mắt", inDev: "Đang phát triển",
    ...
    th: {
      ...
      heroTitle: 'แผงตัวถังเหล็กระดับพรีเมียม<br /><span class="accent-line">เพื่อ Subaru ในตำนาน</span>',
    ...
    ko: {
      ...
      heroTitle: '프리미엄 스틸 바디 패널<br /><span class="accent-line">스바루 아이콘을 위해.</span>',
